      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 w-full md:w-auto">
          <input
            ...
            className="w-full sm:w-64 bg-white px-4 py-2 rounded-md border border-gray-300 text-black
          ...
          {role === 'osas' && (
            <button
              ...
              className="cursor-pointer w-full sm:w-auto bg-[#014fb3] hover:bg-[#013db3] text-white
